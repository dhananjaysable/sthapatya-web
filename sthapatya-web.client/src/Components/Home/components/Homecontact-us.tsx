  ...
  const offices = [
    {
      ...
      title: "Amravati",
      address:
        "4, Swapnashri Colony, Siddhivinayak Nagar, Amravati, Maharashtra 444604",
    },
    {
      name: "Office - Pune",
      image: "./offices/pune.jpg",
      ...
      title: "Pune",
      address:
        "8th Floor, Mount Vert Velocity, Baner - Pashan Link Road, Pune, Maharashtra 411021",
    },
    {
      name: "Office - Thane",
      image: "./offices/thane.jpeg",
    ...
    },
    {
      ...
      title: "Panvel",
      address:
        "A-103 Wing, Yogeshwar Krupa Chs, Thana Naka Road, Old Panvel, Maharashtra 410206",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-8">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "Roboto, sans-serif" }}
            >
              From property surveys to GIS mapping and smart city solutions, we
              deliver end-to-end expertise. Reach out for collaboration.
            </p>
            <div
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#e1d385] tracking-wider">
                    CONSULTANTS
                  </p>
                </div>
              </div>
              <p
                ...
                style={{ fontFamily: "Roboto, sans-serif" }}
              >
                Leading architectural consultancy firm specializing in
                innovative design solutions that blend traditional Indian
                architectural principles with contemporary functionality.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              <p
                ...
                style={{ fontFamily: "Roboto, sans-serif" }}
              >
                © {new Date().getFullYear()} Sthapatya Consultants (India) Pvt.
